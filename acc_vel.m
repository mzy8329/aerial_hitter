function traj_out = acc_vel(pt_s, pt_p, pt_e, dt)
    ...
    a1 = V1^2/(2*T1*V1-2*X1+2*vel_s*T1);
    ...
    for t = dt:dt:t1_e_floor
        pt_temp(1) = x_temp + (vel_s + t1_s_floor*a1)*t;
        pt_temp(2) = (vel_s + t1_s_floor*a1);
        pt_temp(3) = t_temp + t;
        traj_out = [traj_out, pt_temp];
    end
