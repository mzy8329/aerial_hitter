function [uav_hit_pos, arm_hit_pos] = hit2base(uav_pos, arm_pos, pt_hit, vel_hit, l0, l1, alpha, beta)
    ...
    % p2_h = (alpha*l0*(Pt_arm_0_end(3)-Pt_uav_k(3)) + beta*p2_k)/(alpha*l0^2 + beta)
    % n2_h = sqrt((1-p2_h^2)/(1+m1_h^2/n1_h^2));
    % m2_h = n2_h * m1_h/n1_h;
    % e2_h = [m2_h; n2_h; p2_h];
    % pos_arm_0 = atan2(p2_h, sqrt(m2_h^2 + n2_h^2));
    ...
    uav_hit_pos = [Pt_base; tan(n1_h/m1_h)];
